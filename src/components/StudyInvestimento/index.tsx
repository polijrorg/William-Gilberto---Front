...
const StudyInvestimento: React.FC<CardProps> = ({ color, height, width, invest, reloader, setReloader }) => {
    ...
    return (
        <S.VerticalDiv>
            <S.Container height={height} width={width}>
                ...
                <S.StyledText color='#ebebeb' size='16px' margintop={"8px"}>{invest.segment}-{invest.asset}</S.StyledText>
                <S.VerticalDiv>
...
export default StudyInvestimento;